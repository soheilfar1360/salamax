...
export default function BodyMapPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-teal-50/40 px-4 pb-28 pt-8 sm:px-6 sm:py-10">
      ...
      <div className="fixed inset-x-0 bottom-0 z-20 border-t border-slate-200 bg-white/95 p-3 shadow-2xl backdrop-blur sm:hidden">
        <div className="mx-auto flex max-w-6xl gap-2">
          <button
            ...
            onClick={handleContinue}
            disabled={painMarkers.length === 0}
            className={`flex-1 rounded-2xl px-5 py-3 text-center text-white transition ${
              painMarkers.length > 0
          ...
          <Link
            href="/intake"
            className="rounded-2xl border border-slate-300 px-5 py-3 text-center text-slate-700"
          >
            بازگشت
          </Link>
        </div>
